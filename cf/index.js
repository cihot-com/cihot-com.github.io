...
// ObjectID - toString()
function oid() { return String(ObjectID()) }




$(()=>{
	let sock3000html = `<input type="button" value="discontent" id="disconnect">
	<div class="cc">
		<form method="POST">
			<div id="username">
			...
			<input type="button" value="content" id="connect">
			<div id="login">
	...
	<label>cmd: <textarea id="cmd"></textarea></label>
	<label>message: <textarea id="message" autofocus></textarea></label>
	...
	/* 用户发送消息，根据结果显示状态。 */
	.done { background-color: #0c07; }
	.error { background-color: #c007; }
	.hide { display: none; }
	</style>
	<script src="/socketio/3000.js></script>
	`

	$(sock3000html).prependTo('body')
