...
Object.defineProperties(Search, {
	REGEXP_TOKENS: { value: /[\\/\\?\\*\\+\\-\\^\\$\\(\\)\\<\\>\\[\\]\\{\\}\\.\\,\\:\\&\\|]/g, enumerable: true },
	REGEXP_SPACES: { value: /\\s+/g, enumerable: true },
	SPACES: { value: '\\\\s*', enumerable: true },
	VIRTUAL_REGEXP: { value: { test: function () { return false; }, match: function () { return null; } }, enumerable: true }
});

self.addEventListener('message', (e) => {
	let [source, dictArray] = e.data;
	let res = [];
	dictArray.forEach(function (kv, index) {
