import{b as e,j as t,n as i}from"./index-8f1f19a3.js";import"./index-1bbb7398.js";import{B as n}from"./ButtonGroup-c5fe2656.js";import{B as s}from"./Button-16e2b8ce.js";import{R as o,a as r}from"./ingredients-82c0d4c8.js";import{u as l}from"./use-drag-controls-b7c77f79.js";import{m as a}from"./motion-abf7f7de.js";import{A as d}from"./index-f26583fd.js";import{c}from"./emotion-react.browser.esm-492a199c.js";import{u}from"./use-motion-value-cdb7a71a.js";import{a as p}from"./animate-660fb2bc.js";import"./createTheme-5544a3df.js";import"./index-b55ce3dc.js";import"./styled-9e3ddff4.js";import"./assertThisInitialized-c6bb24a5.js";import"./inheritsLoose-5d4bdff6.js";import"./setPrototypeOf-b9a4b5f8.js";import"./SVGVisualElement-210c37ed.js";import"./index-7074372a.js";import"./use-transform-bfeb503f.js";import"./use-unmount-effect-e9aae080.js";import"./resolve-element-7c72327c.js";const m=i(o.Group)`
  display: flex;
  flex-direction: ${({direction:e})=>e};
  position: relative;
  gap: 4px;
`;function x({item:e}){const i=l();return t.jsxs(o.Item,{as:"li",className:"item",value:e,dragListener:!1,dragControls:i,children:[e,t.jsx("button",{onPointerDown:e=>{i.start(e)},children:"+"})]},`k-${e}`)}function h(){const[i,o]=e.useState("x"),[r,l]=e.useState((()=>[1,2,3])),a=e.useMemo((()=>"x"===i?"row":"column"),[i]);return t.jsxs(j,{children:[t.jsxs(n,{children:[t.jsx(s,{onClick:()=>o("x"),children:"x"}),t.jsx(s,{onClick:()=>o("y"),children:"y"})]}),t.jsx("div",{children:t.jsx(m,{as:"ul",axis:i,direction:a,className:"group",values:r,onReorder:e=>{l(e)},children:r.map((e=>t.jsx(x,{item:e},e)))})})]})}const j=i.div`
  .item {
    width: 100px;
    list-style: none;
    /* position: relative; */
...
`,f=[{id:1,name:"a"},{id:2,name:"b"},{id:3,name:"c"}],g=i.div`
  ul {
    display: flex;
    justify-content: space-between;
    align-items: center;
...
`;function b(){const[i,n]=e.useState(f[0]);return t.jsxs(g,{children:[t.jsx("nav",{children:t.jsx("ul",{children:f.map((e=>t.jsxs(a.li,{onClick:()=>n(e),className:i===e?"selected":"",whileHover:{backgroundColor:"#8888"},children:[e.name,e===i?t.jsx(a.div,{className:"underline",layoutId:"underline"}):null]},e.id)))})}),t.jsx("main",{children:t.jsx(d,{mode:"wait",children:t.jsx(a.div,{initial:{y:10,opacity:0},animate:{y:0,opacity:1},exit:{y:-10,opacity:0},transition:{duration:.2},children:i?i.name:"empty"},i?i.id:"empty")})})]})}const y=i.div`
  /* min-height: 110vh;
  display: flex;
