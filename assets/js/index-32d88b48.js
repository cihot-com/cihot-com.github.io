import{b as t,j as e,n}from"./index-890d70c3.js";import{u as s}from"./use-motion-value-9c2a72a8.js";import{i as r,a as i,f as o,m as c}from"./SVGVisualElement-77214677.js";import{M as a,u,m as l}from"./motion-1e207df9.js";import{u as f,a as m}from"./use-transform-54c0589b.js";import"./index-7074372a.js";function d(t,...e){const n=t.length;return f(e.filter(r),(function(){let s="";for(let i=0;i<n;i++){s+=t[i];const n=e[i];n&&(s+=r(n)?n.get():n)}return s}))}function g(e){const n=s(e.getVelocity());return function(e,n,s){t.useInsertionEffect((()=>e.on(n,s)),[e,n,s])}(e,"velocityChange",(t=>{n.set(t)})),n}const p=n.figure`
  .item {
    width: 100px;
    height: 100px;
    background: #8888;
