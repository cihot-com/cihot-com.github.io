...
LevelDirector.prototype.initSorties = function()
{
   ...
   if ( this.myCurrentLevel == 1 )
   {
      var sortie = new Sortie(500);
      sortie.add("enemy_small_special",   200, 165, 0, 0);// 速度
      sortie.add("enemy_small_2_special",   200, 165, 0, 0);
      sortie.add("enemy_small_3", 200, 165, 0, 0);
      sortie.add("enemy_small_4_special",   200, 165, 0, 0);
      sortie.add("enemy_small_4_special",   200, 165, 0, 0);
      sortie.add("enemy_small_4_special",   200, 165, 0, 0);
      sortie.add("enemy_small_4_special",   200, 165, 0, 0);
      sortie.add("enemy_small_4_special",   200, 165, 0, 0);
      ...
      sortie = new Sortie(3900)
      sortie.add("enemy_small_2",         200, 165, 0, 0);
      sortie.add("enemy_small_2",         200, 165, 0, 0);
      sortie.add("enemy_small_2",         200, 165, 0, 0);
      sortie.add("enemy_small_2_special", 200, 165, 0, 0);
      this.mySorties.push(sortie);

      sortie = new Sortie(4300);
      sortie.add("enemy_small_3",         200,  165, 0, 0);
      sortie.add("enemy_small_3",         200,  165, 0, 0);
      sortie.add("enemy_small_3",         200,  165, 0, 0);
      ...
      sortie = new Sortie(4900);
      sortie.add("enemy_small_special",         200, 165,  0, 0);
      sortie.add("enemy_small_special",         200, 165, 0, 0);
      sortie.add("enemy_small_special",         200, 165, 0, 0);
      sortie.add("enemy_small_special",         200, 165, 0, 0);
      this.mySorties.push(sortie);

      sortie = new Sortie(5400);
      sortie.add("enemy_small",               200,165, 0, 0);
      sortie.add("enemy_small",               200,165, 0, 0);
      sortie.add("enemy_small",               200,165, 0, 0);
      sortie.add("enemy_small",               200,165, 0, 0);
      sortie.add("enemy_small_3",             200,165, 0, 0);
      ...
      sortie = new Sortie(7350);
      sortie.add("enemy_small_4",   200,165,0,0);
      sortie.add("enemy_small_4",   200,165,0,0);
      sortie.add("enemy_artifact_2",200,165,0,0);
      sortie.add("enemy_small_4",   200,165,0,0);
      sortie.add("enemy_small_4",   200,165,0,0);
      sortie.add("enemy_small_4",   200,165,0,0);
      sortie.add("enemy_small_4",   200,165,0,0);
